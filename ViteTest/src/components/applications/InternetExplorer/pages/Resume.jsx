    ...
    return (
        <div className="ie-classic-page">
            ...
            <div className="xp-card">
                <div className="xp-card-title">Worcester Polytechnic Institute - Adjunct Professor (Aug 2024 -
                    Present)
                </div>
            ...
            <div className="xp-card">
                ...
                <div className="xp-card-content">
                    <ul>
                        <li>Maintained Unity build pipelines for 8 mobile applications under simultaneous active
                            development across Android and iOS platforms.
                        </li>
                        <li>Organized software workshops and training documentation for a team of 30+ developers working
                            together for the first time as part of the 2024 Summer Innovation Program.
                        </li>
                    </ul>
                </div>
            </div>
